...
@section('content')
    <div class="page-body">
        <div class="container-xl">
            <x-core-form class="block-double-click" :action="route('cms.voucher.store')" type="post" :validate="true">
                <div class="row justify-content-center">
                    @include('cms.vouchers.forms.create-left')
                    @include('cms.vouchers.forms.create-right')
                </div>
