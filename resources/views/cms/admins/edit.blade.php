...
@section('content')
    <div class="page-body">
        <div class="container-xl">
            <x-core-form class="block-double-click" :action="route('cms.admin.update')" type="put" :validate="true">
                <x-core-input type="hidden" name="id" :value="$admin->id" />
                <div class="row justify-content-center">
                    @include('cms.admins.forms.edit-left')
                    @include('cms.admins.forms.edit-right')
                </div>
