...
/**
* @see \Domains\Blog\Http\Controllers\Cms\PostCommentController::updateMultiple
...
const PostCommentController = { index, create, store, update, edit, deleteMethod, updateMultiple, delete: deleteMethod }
