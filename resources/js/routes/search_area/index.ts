...
* @route '/search-area/district/{hrv_province_id?}'
*/
const districtForm = (args?: { hrv_province_id?: string | number } | [hrv_province_id: string | number ] | string | number, options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
    action: district.url(args, options),
    method: 'get',
})
...
* @route '/search-area/district/{hrv_province_id?}'
*/
districtForm.get = (args?: { hrv_province_id?: string | number } | [hrv_province_id: string | number ] | string | number, options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
    action: district.url(args, options),
    method: 'get',
})
...
* @route '/search-area/district/{hrv_province_id?}'
*/
districtForm.head = (args?: { hrv_province_id?: string | number } | [hrv_province_id: string | number ] | string | number, options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
    action: district.url(args, {
        [options?.mergeQuery ? 'mergeQuery' : 'query']: {
            _method: 'HEAD',
            ...(options?.query ?? options?.mergeQuery ?? {}),
        }
...
* @route '/search-area/district-by-province'
*/
const search_districtForm = (options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
    action: search_district.url(options),
    method: 'get',
})
...
* @route '/search-area/district-by-province'
*/
search_districtForm.get = (options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
    action: search_district.url(options),
    method: 'get',
})
...
* @route '/search-area/district-by-province'
*/
search_districtForm.head = (options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
    action: search_district.url({
        [options?.mergeQuery ? 'mergeQuery' : 'query']: {
            _method: 'HEAD',
            ...(options?.query ?? options?.mergeQuery ?? {}),
        }
...
search_district.form = search_districtForm
