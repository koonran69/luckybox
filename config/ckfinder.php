...
$config['authentication'] = 'Domains\Core\Http\Middleware\CustomCKFinderAuth';

/*============================ License Key ============================================*/
// http://docs.cksource.com/ckfinder3-php/configuration.html#configuration_options_licenseKey

$config['licenseName'] = env('LICENSE_CKFINDER_NAME');
$config['licenseKey']  = env('LICENSE_CKFINDER_KEY');
...
$config['resourceTypes'][] = array(
    ...
    'directory'         => 'images',
    'maxSize'           => 0,
    'allowedExtensions' => 'bmp,gif,jpeg,jpg,png,webp,avif',
    'deniedExtensions'  => '',
    'backend'           => 'default'
);
